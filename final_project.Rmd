...
```{r}
set.seed(123)
training_data <- df_fit$missing_sexid %>% createDataPartition(p = 0.01, list = F)
...
model_fit_3 <- train(missing_sexid ~., data = train_data, method = "rf", metric = "Accuracy", preProc=c("center", "scale"),
